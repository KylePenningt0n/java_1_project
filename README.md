# java_1_project
This is my first java project with WGU It is a product and part management application using java fx.
The lines below are the instructions for the project
